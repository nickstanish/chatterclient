...
public abstract class Client implements Connection, Runnable {
	...
	protected final boolean prepareAndSendMessage(Message.Type type, String[] recipients, String message, 
			SimpleAttributeSet style, boolean typing){
		Message m = null;
		switch(type){
			case Command:
	...
	public final void run(){
		...
		while(keepGoing){
			...
			try {
				...
				messageHandler(new Message(Message.Type.Error, "IO Error in thread " + Thread.currentThread().getName()));
			}
